    ...
    <div className='port__header section__padding' id='about'>
      ...
      <div className='port__header-content'>
        ...
        <div className='port__header-content_bio'>
            <p>Hi there! I'm <b style={{color:'#FB8B23'}}>Scott Niblock</b>, a passionate React developer based in Austin, Texas, dedicated to creating dynamic and user-friendly web applications. With a strong foundation in JavaScript and expertise in modern web technologies, I strive to bring innovative solutions to life.</p>
